...
const ColorBlocksDiagram = () => {
  ...
  const addNewBlock = () => {
    ...
    setNewBlock({
      ...newBlock,
      name: '',
      x: Math.max(50, Math.min(600, (newBlock.x || 0) + 20)),
      y: Math.max(50, Math.min(500, (newBlock.y || 0) + 20))
    });
  };

  // 更新新色塊屬性
  const handleNewBlockChange = (field: keyof Block, value: any) => {
    setNewBlock({
      ...newBlock,
      [field]: value
    });
            ...
            <div className="flex flex-col gap-3 border p-3 rounded">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <select 
                    value={newBlock.type} 
                    onChange={(e) => handleNewBlockChange('type', e.target.value as 'rect' | 'circle')}
                ...
                <div>
                  ...
                  <input 
                    type="color" 
                    value={newBlock.textColor || '#FFFFFF'} 
